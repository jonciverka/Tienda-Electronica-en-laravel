...
<body>
	...
	<nav>
    	<div class="nav-wrapper blue darken-3">
      	<a href="{!!URL::to('/')!!}" class="brand-logo"><img src="img/Logo-Siscom.png"></a>
      	<ul id="nav-mobile" class="right hide-on-med-and-down">
        	<li>Usuario</li>
          <li><a href="{!!URL::to('/all')!!}">Todo</a></li>
        	<li><i class="large material-icons">local_grocery_store</i></li>   
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col l4 offset-l2 s12">
                <a href="#" class="brand-logo"><img src="img/Logo-Siscom.png"></a>
                <ul>
                </ul>
              </div>
            </div>
